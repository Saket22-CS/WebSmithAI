...
import { Code2Icon, Download, Ghost, Monitor, SquareArrowOutUpRight, TabletSmartphone } from 'lucide-react'
  ...
  return (
    <div className='p-2 shadow rounded-xl w-full flex items-center justify-between'>
        ...
        <div className='flex gap-2'>
            ...
            onClick={()=>ViewInNewTab()}>View <SquareArrowOutUpRight/></Button>
